...
class MainWindow:
    ...
    def _create_ui(self) -> None:
        header = tk.Frame(self.root, padx=25, pady=18)
        header.pack(fill="x")
    ...
    def _create_sidebar(self, parent: tk.Widget) -> None:
        ...
        menu_title.pack(anchor="w", pady=(0, 15))

        menus = [
            ("주문관리", self.open_orders),
            ("상품관리", self.show_preparing),
            ("공급처관리", self.show_preparing),
    ...
    def _create_dashboard(self, parent: tk.Widget) -> None:
        content = tk.Frame(parent, padx=35, pady=30)
        ...
        description = tk.Label(
            content,
            text="비선상회 주문·발주 업무를 한곳에서 관리합니다.",
            font=("맑은 고딕", 12),
        )
        description.pack(anchor="w", pady=(5, 25))
        ...
        action_frame.pack(fill="x", pady=(35, 0))
