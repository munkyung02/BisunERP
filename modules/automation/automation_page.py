...
class AutomationPage(ttk.Frame):
    ...
    def _build_ui(self) -> None:
        ...
        definitions = (
            ...
            ("delivery", "5. 배송조회 및 배송상태 관리", "열기", self._open_delivery),
        )
        ...
        ttk.Label(
            ...
            text=(
                ...
                "송장 등록 후 배송현황에서 택배사 조회와 상태 관리를 진행할 수 있습니다."
            ),
        ).grid(row=0, column=0, sticky="w")
        ttk.Button(
            footer,
    ...
    def _open_delivery(self) -> None:
        self.step_status_vars["delivery"].set("화면 열기")
        self._append_log("[배송조회] 배송현황 화면을 열었습니다.")
